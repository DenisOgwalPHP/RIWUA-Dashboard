...
<head>
  ...
  <title>Crop Protection | SMS </title>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
			   <form action="insertSMS.php" method="post" >
			   <div class="form-group">
                    <label>Message</label>
                    <textarea class="form-control" rows="3" name="messsage" placeholder="Enter Message..."></textarea>
               </div>
			   <div class="form-group">
                    <label>Contact</label>
                    <select class="form-control" name="people" >
                      <option Value="All Farmers">All Farmers</option>
                      <option Value="All Extension Workers">All Extension Workers</option>
			   ...
			   <div class="form-group">
				...
				<div class="form-group">
                  <button type="submit" name="smsupload" class="btn btn-primary">Submit</button>
				</div> 
				  </form>
				  <!---->
              </div>
            ...
            <div class="card card-info">
             ...
             <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT Contact,Name,TimeRegistered,Message FROM `message` order by messageid Desc LIMIT 10";
