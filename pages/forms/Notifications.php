        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
			   <form action="insertnotifications.php" method="post" >
			   <div class="form-group">
                    <label for="exampleInputEmail1">Subject</label>
					<input class="form-control" type="text" name="notificationsubject" placeholder="Enter Subject">
               </div>
			   <div class="form-group">
                    <label>Notification Message</label>
                    <textarea class="form-control" name="notificationbody" rows="3" placeholder="Enter notification Message..."></textarea>
               </div>
			    <div class="form-group">
                    <label for="exampleInputEmail1">Posted By</label>
					<input class="form-control" type="text" name="postedby" placeholder="Posted by...">
               </div>
			   <div class="form-group">
				 <label>&nbsp;</label>
				</div>
				...
				<div class="form-group">
                  <button type="submit" name="notificationupload" class="btn btn-primary">Submit</button>
				</div> 
				  </form>
				  <!--<div class="form-group">
                    <label>Select</label>
            ...
            <div class="card card-info">
             ...
             <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT Subject,Sender,TimeSent,RealMessage FROM `notifications` order by notificationid Desc LIMIT 10";
