...
if(isset($_REQUEST['Statisticupload'])){	
// getting inputs from the form	
   $statisticname = $_POST['statisticname'];
	...
	$query = "INSERT INTO `statistics` (Statistic,Details,PostedBy,Attachment) VALUES('$statisticname','$statisticdescription','$postedby','$finalimageurl')";
			$result=mysqli_query($link,$query);
			if($result){
				echo '<script type="application/javascript">';
				echo'alert("Statistics successfully registered");';
				echo'window.location.href="Statistic.php";';
				echo '</script>';
			}else{
				echo '<script type="application/javascript">';
