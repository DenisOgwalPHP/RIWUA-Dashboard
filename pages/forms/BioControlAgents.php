        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
			   <form action="insertbiocontrolagents.php" method="post" enctype="multipart/form-data">
			   ...
			   <div class="form-group">
				...
				<div class="form-group">
                  <button type="submit" name="biocontrolagentupload" class="btn btn-primary">Submit</button>
				</div> 
				  </form>
				  <!--<div class="form-group">
                    <label>Select</label>
