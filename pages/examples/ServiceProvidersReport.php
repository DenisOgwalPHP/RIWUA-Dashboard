      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="ServiceProvidersReport.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Service Providers</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="AdviseReport.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Advise</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="BiocontrolReport.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Bio Control Agents</p>
                </a>
              </li>
			  <li class="nav-item">
                <a href="DiseaseReport.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Crop Diseases</p>
                </a>
              </li>
			  <li class="nav-item">
                <a href="StatisticsReport.php" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>Statistics</p>
                </a>
              </li>
        ...
        <div class="row">
          <div class="col-12">
            <div class="callout callout-info">
              ...
              This page is a display of all the service providers registered with the system in A desceding way based on Order of registration, so you can print them accordingly.
            </div>
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
               ...
               <?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT ProviderName,Services,Contact,Email,TimeRegistered, Description FROM `serviceproviders` order by providerid Desc LIMIT 10";
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-6">
                  <p class="lead">Total Service Providers</p>
...
require_once('../../Connection/connect.php');
$dates1=date("Y");
$sales ="SELECT COUNT(providerid) as ServiceProviders FROM `ServiceProviders`";
$result=mysqli_query($link,$sales);
$row=mysqli_fetch_assoc($result);
...
?> 
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="ServiceProvidersPrint.php" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
