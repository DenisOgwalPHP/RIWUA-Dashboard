        ...
        <div class="row">
          <div class="col-12">
            <div class="callout callout-info">
              ...
              This page is a display of all the Diseases registered with the system in A desceding way based on Order of registration, so you can print this accordingly.
            </div>
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
               ...
               <?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT Disease,Description,PostedBy,PostDate,Attachment FROM `Diseases` order by Diseaseid Desc";
...
require_once('../../Connection/connect.php');
$dates1=date("Y");
$sales ="SELECT COUNT(Diseaseid) as ServiceProviders FROM `Diseases`";
$result=mysqli_query($link,$sales);
$row=mysqli_fetch_assoc($result);
...
?> 
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="DiseasePrint.php" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
