        ...
        <div class="row">
          <div class="col-12">
            <div class="callout callout-info">
              ...
              This page is a display of all the Advise registered with the system in A desceding way based on Order of registration, so you can print this accordingly.
            </div>
...
?> 
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="AdvisePrint.php" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
