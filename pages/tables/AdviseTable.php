        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Advise Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT Subject,Message,SentBy,Sent_At,Attachment,Adviseid FROM `Advise` order by Adviseid Desc";
				...
				while($row5=mysqli_fetch_assoc($result5)){
				 ...
				 $adviseid=$row5['Adviseid']; 
				  echo'<td><form method="get" ><a href="EditAdvise.php"><button type="submit" name="Edit"  value="'.$adviseid.'" class="btn btn-block btn-warning">Edit</button></a></form></td>'; 
				  echo'<td><form method="get" ><a href="AdviseTable.php"><button type="submit" name="delete"  value="'.$adviseid.'" class="btn btn-block btn-danger">Delete</button></a></form></td>'; 
                echo"</tr>";
				}
				?>
				<?php
				if(isset($_GET['delete'])){
					$adviseid=$_GET['delete'];	
                        if(isset($adviseid)){
				$sales6 ="DELETE  FROM Advise WHERE Adviseid='".$adviseid."'";
				$result=mysqli_query($link,$sales6);
				if($result){
				echo '<script type="application/javascript">';
				echo'alert("Advise successfully Deleted");';
				echo'window.location.href="AdviseTable.php";';
				echo '</script>';
							}else{
				echo '<script type="application/javascript">';
			    echo'alert("Advise Delete Failed");';
				//echo'alert("'.$id.'");';
				echo'window.location.href="AdviseTable.php";';
				echo '</script>';
								}
				...
				if(isset($adviseid)){
					...
					echo'window.location.href = "EditAdvise.php?Edit='.$adviseid.'"';
					echo'</script>';
