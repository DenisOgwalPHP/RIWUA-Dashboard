        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
			  <form action="UpdateStatistics.php?Edit=<?php echo $_GET['Edit']; ?>" method="post" enctype="multipart/form-data">
			   <div class="form-group">
                    <label for="exampleInputEmail1">Statistics</label>
					<input class="form-control" type="text" name="statisticname" placeholder="Enter Statistic header">
               </div>
			   <div class="form-group">
                    <label>Description</label>
                    <textarea class="form-control" rows="3" name="statisticdescription" placeholder="Enter statistic short Description..."></textarea>
               </div>
			    <div class="form-group">
                    <label for="exampleInputEmail1">Posted By</label>
					<input class="form-control" name="postedby" type="text" placeholder="Posted by...">
               </div>
				...
				<div class="form-group">
				   <button type="submit" name="UpdateStatisticupload" class="btn btn-block btn-warning">Update</button>
				</div>  
				  </form>
				  <!--<div class="form-group">
                    <label>Select</label>
            ...
            <div class="card card-info">
             ...
             <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT Statistic,PostedBy,postdate FROM `statistics` order by Statisticsid Desc LIMIT 10";
