        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
			  <form action="updateadvise.php?Edit=<?php echo $_GET['Edit']; ?>" method="post" enctype="multipart/form-data">
			   <div class="form-group">
                    <label for="exampleInputEmail1">Subject</label>
					<input class="form-control" type="text" name="advisesubject" placeholder="Enter Subject">
               </div>
			   <div class="form-group">
                    <label>Message</label>
                    <textarea class="form-control" rows="3" name ="advisemessage" placeholder="Enter Message..."></textarea>
               </div>
			    <div class="form-group">
                    <label for="exampleInputEmail1">Posted By</label>
					<input class="form-control" type="text" name="adviseposted" placeholder="Posted by...">
               </div>
				...
				<div class="form-group">
				   <button type="submit" name="Updateadviseupload" class="btn btn-block btn-warning">Update</button>
				</div> 
				  </form>
            ...
            <div class="card card-info">
             ...
             <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT Subject,SentBy,Sent_At FROM `advise` order by Adviseid Desc LIMIT 10";
