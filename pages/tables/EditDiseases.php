        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
			  <form action="updatedisease.php?Edit=<?php echo $_GET['Edit']; ?>" method="post" enctype="multipart/form-data">
			   ...
			   <div class="form-group">
				...
				<div class="form-group">
				   <button type="submit" name="UpdateDiseaseupload" class="btn btn-block btn-warning">Update</button>
				</div>  
				  </form>
