  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Bio Control Agents</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../Dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Bio Control Agents</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
			   <form action="updatebiocontrolagents.php?Edit=<?php echo $_GET['Edit']; ?>" method="post" enctype="multipart/form-data">
			   <div class="form-group">
                    <label for="exampleInputEmail1">Bio Control Agent</label>
					<input class="form-control" type="text" name="biocontrolname" placeholder="Enter Bio Control Agent Name">
               </div>
			   <div class="form-group">
                    <label>Details</label>
                    <textarea class="form-control"  rows="3" name="biocontroldetails" placeholder="Enter Bio Control Agent Details..."></textarea>
               </div>
			    <div class="form-group">
                    <label for="exampleInputEmail1">Posted By</label>
					<input class="form-control" name="biocontrolpostedby" type="text" placeholder="Posted by...">
               </div>
				...
				<div class="form-group">
				   <button type="submit" name="UpdateBiocontrolupload" class="btn btn-block btn-warning">Update</button>
				</div> 
				  </form>
            ...
            <div class="card card-info">
             ...
             <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT BioAgent,Postedby,Posted_at FROM `biocontrolagents` order by Biocontrolid Desc LIMIT 10";
