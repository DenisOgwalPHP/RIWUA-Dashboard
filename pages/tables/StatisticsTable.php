...
<head>
  ...
  <title>Crop Protection | Statistics </title>
   <!-- Font Awesome Icons -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Statistics Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT Statistic,Details,PostedBy,postdate,Attachment,Statisticsid FROM `statistics` order by Statisticsid Desc";
				$result5=mysqli_query($link,$sales6);
				$counter1=1;
				while($row5=mysqli_fetch_assoc($result5)){
                 echo"<tr>";
				 echo "<td>".$row5['Statistic']."</td>";
				 ...
				 $Statisticsid=$row5['Statisticsid'];
				  echo'<td><form method="get" ><a href="EditStatistic.php"><button type="submit" name="Edit"  value="'.$Statisticsid.'" class="btn btn-block btn-warning">Edit</button></a></form></td>'; 
				  echo'<td><form method="get" ><a href="StatisticsTable.php"><button type="submit" name="delete"  value="'.$Statisticsid.'" class="btn btn-block btn-danger">Delete</button></a></form></td>'; 
                echo"</tr>";
				}
				?>
				<?php
				if(isset($_GET['delete'])){
					$Statisticsid=$_GET['delete'];	
                        if(isset($Statisticsid)){
				$sales6 ="DELETE  FROM statistics WHERE Statisticsid='".$Statisticsid."'";
				$result=mysqli_query($link,$sales6);
				if($result){
				echo '<script type="application/javascript">';
				echo'alert("Statistics successfully Deleted");';
				echo'window.location.href="StatisticsTable.php";';
				echo '</script>';
							}else{
				echo '<script type="application/javascript">';
				echo'alert("Statistics Delete Failed");';
				//echo'alert("'.$id.'");';
				echo'window.location.href="StatisticsTable.php";';
				echo '</script>';
								}
				...
				if(isset($Statisticsid)){
					...
					echo'window.location.href = "EditStatistic.php?Edit='.$Statisticsid.'"';
					echo'</script>';
