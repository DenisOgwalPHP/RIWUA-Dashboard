...
<head>
  ...
  <title>Crop Protection | Service Providers </title>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Service Providers Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT ProviderName,Services,Contact,Email,TimeRegistered, Description, ImageURL,providerid FROM `serviceproviders` order by providerid Desc";
				$result5=mysqli_query($link,$sales6);
				$counter1=1;
				while($row5=mysqli_fetch_assoc($result5)){
                 echo"<tr>";
				 echo "<td>".$row5['ProviderName']."</td>";
				 echo "<td>".$row5['Services']."</td>";
                 echo "<td>".$row5['Contact']."</td>";
                 echo "<td>".$row5['Email']."</td>";
				 echo "<td>".$row5['TimeRegistered']."</td>";
				 echo "<td>".$row5['Description']."</td>";
				 echo "<td><img src=".$row5['ImageURL']." height='100' width='100'></td>";
				 
				  $providerid=$row5['providerid']; 
				  echo'<td><form method="get" ><a href="EditServiceProviders.php"><button type="submit" name="Edit"  value="'.$providerid.'" class="btn btn-block btn-warning">Edit</button></a></form></td>'; 
				  echo'<td><form method="get" ><a href="ServiceProviders.php"><button type="submit" name="delete"  value="'.$providerid.'" class="btn btn-block btn-danger">Delete</button></a></form></td>'; 
                echo"</tr>";
				}
				?>
				<?php
				if(isset($_GET['delete'])){
					$providerid=$_GET['delete'];	
                        if(isset($providerid)){
				$sales6 ="DELETE  FROM serviceproviders WHERE providerid='".$providerid."'";
				$result=mysqli_query($link,$sales6);
				if($result){
				echo '<script type="application/javascript">';
				echo'alert("Service Provider successfully Deleted");';
				echo'window.location.href="ServiceProvidersTable.php";';
				echo '</script>';
							}else{
				echo '<script type="application/javascript">';
				echo'alert("Service Provider Delete Failed");';
				//echo'alert("'.$id.'");';
				echo'window.location.href="ServiceProvidersTable.php";';
				echo '</script>';
								}
				...
				if(isset($providerid)){
					...
					echo'window.location.href = "EditServiceProviders.php?Edit='.$providerid.'"';
					echo'</script>';
