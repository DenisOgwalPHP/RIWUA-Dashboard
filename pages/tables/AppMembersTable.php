        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">App Users Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT FullNames,Email,Telephone,Address,created_at,ApprovalStatus,ProfilePic,IDDesc FROM `registration` where DOB is NULL order by IDDesc Desc";
