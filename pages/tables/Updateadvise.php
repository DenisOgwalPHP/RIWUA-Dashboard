...
if(isset($_REQUEST['Updateadviseupload'])){	
// getting inputs from the form	
   ...
   $Adviseid = $_GET['Edit'];
	...
	$target = "../forms/AdviseAttachments/";	
	...
	$query = "Update  `advise` Set Subject='".$advisesubject."', Message='".$advisemessage."' ,SentBy ='".$adviseposted."' where Adviseid='".$Adviseid."'";
			$result=mysqli_query($link,$query);
			if($result){
				echo '<script type="application/javascript">';
				echo'alert("Advise successfully Updated");';
				echo'window.location.href="AdviseTable.php";';
				echo '</script>';
			}else{
				echo '<script type="application/javascript">';
				echo'alert("Advise Update Failed");';
				echo'window.location.href="AdviseTable.php";';
				echo '</script>';
			}
