...
<head>
  ...
  <title>Crop Protection | Biocontrol Agents  </title>
   <!-- Font Awesome Icons -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Biocontrol Agents</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../Dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Biocontrol Agents</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Biocontrol Agents Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT BioAgent,Details,Postedby,Posted_at,Attachment,Biocontrolid FROM `biocontrolagents` order by Biocontrolid Desc";
				...
				while($row5=mysqli_fetch_assoc($result5)){
				 ...
				 echo "<td>
				 <button type='button' class='btn btn-block btn-primary' onclick='".$row5['Attachment']."'>"."Download"."</button>
				 </td>";
				 $Biocontrolid=$row5['Biocontrolid'];
				  echo'<td><form method="get" ><a href="EditBiocontrolAgents.php"><button type="submit" name="Edit"  value="'.$Biocontrolid.'" class="btn btn-block btn-warning">Edit</button></a></form></td>'; 
				  echo'<td><form method="get" ><a href="BiocontrolagentsTable.php"><button type="submit" name="delete"  value="'.$Biocontrolid.'" class="btn btn-block btn-danger">Delete</button></a></form></td>'; 
                echo"</tr>";
				}
				?>
				<?php
				if(isset($_GET['delete'])){
					$Biocontrolid=$_GET['delete'];	
                        if(isset($Biocontrolid)){
				$sales6 ="DELETE  FROM biocontrolagents WHERE Biocontrolid='".$Biocontrolid."'";
				$result=mysqli_query($link,$sales6);
				if($result){
				echo '<script type="application/javascript">';
				echo'alert("Bio Control Agent successfully Deleted");';
				echo'window.location.href="BiocontrolagentsTable.php";';
				echo '</script>';
							}else{
				echo '<script type="application/javascript">';
				echo'alert("Bio Control Agent Delete Failed");';
				//echo'alert("'.$id.'");';
				echo'window.location.href="BiocontrolagentsTable.php";';
				echo '</script>';
								}
				...
				if(isset($Biocontrolid)){
					...
					echo'window.location.href = "EditBiocontrolAgents.php?Edit='.$Biocontrolid.'"';
					echo'</script>';
				//header('location.href=EditAdvise.php');	
				}
				}
				?>				
                </tbody>
