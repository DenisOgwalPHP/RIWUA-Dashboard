        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Diseases Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT Disease,Description,PostedBy,PostDate,Attachment, Diseaseid FROM `Diseases` order by Diseaseid Desc";
				...
				while($row5=mysqli_fetch_assoc($result5)){
				 ...
				 <button type='button' class='btn btn-block btn-primary' onclick='".$row5['Attachment']."'>"."Download"."</button>
				  ...
				  $Diseaseid=$row5['Diseaseid'];
				  echo'<td><form method="get" ><a href="EditDiseases.php"><button type="submit" name="Edit"  value="'.$Diseaseid.'" class="btn btn-block btn-warning">Edit</button></a></form></td>'; 
				  echo'<td><form method="get" ><a href="BiocontrolagentsTable.php"><button type="submit" name="delete"  value="'.$Diseaseid.'" class="btn btn-block btn-danger">Delete</button></a></form></td>'; 
                echo"</tr>";
				}
				?>
				<?php
				if(isset($_GET['delete'])){
					$Diseaseid=$_GET['delete'];	
                        if(isset($Diseaseid)){
				$sales6 ="DELETE  FROM diseases WHERE Diseaseid='".$Diseaseid."'";
				$result=mysqli_query($link,$sales6);
				if($result){
				echo '<script type="application/javascript">';
				echo'alert("Disease successfully Deleted");';
				echo'window.location.href="DiseaseTable.php";';
				echo '</script>';
							}else{
				echo '<script type="application/javascript">';
				echo'alert("Disease Delete Failed");';
				//echo'alert("'.$id.'");';
				echo'window.location.href="DiseaseTable.php";';
				echo '</script>';
								}
				...
				if(isset($Diseaseid)){
					...
					echo'window.location.href = "EditDiseases.php?Edit='.$Diseaseid.'"';
					echo'</script>';
