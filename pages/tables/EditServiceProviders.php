        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
			    <form action="Updateserviceproviders.php?Edit=<?php echo $_GET['Edit']; ?>" method="post" enctype="multipart/form-data">
			   <div class="form-group">
                    <label for="exampleInputEmail1">Service Provider Name</label>
					<input class="form-control" type="text" name= "providername" placeholder="Enter Service Provider Names">
               </div>
			 
			   <div class="form-group">
                    <label>Services Offered</label>
                    <textarea class="form-control" rows="3"  name="servicesoffered" placeholder="Enter services..."></textarea>
               </div>
			   <div class="form-group">
                    <label for="exampleInputEmail1">Telephone Contact</label>
					<input class="form-control" type="number" name="telenumber" placeholder="Enter Service Provider Names">
               </div>
			   
			   <div class="form-group">
                    <label for="exampleInputEmail1">Email address</label>
                    <input type="email" class="form-control" name="emailaddress" id="exampleInputEmail1" placeholder="Enter email">
                  </div>
				<div class="form-group">
				...
				<div class="form-group">
				   <button type="submit" name="UpdateServiceProviderupload" class="btn btn-block btn-warning">Update</button>
				</div> 
				  </form>
            ...
            <div class="card card-info">
             ...
             <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT ProviderName,Contact,Email,TimeRegistered FROM `serviceproviders` order by providerid Desc";
