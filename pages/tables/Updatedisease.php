...
if(isset($_REQUEST['UpdateDiseaseupload'])){	
// getting inputs from the form	
	...
	$target = "../forms/DiseaseAttachments/";	
	...
	$query = "UPDATE `Diseases` SET Disease='".$diseasename."',Description='".$diseasedescription."',PostedBy='".$postednames."' WHERE Diseaseid='".$Diseaseid."' ";
