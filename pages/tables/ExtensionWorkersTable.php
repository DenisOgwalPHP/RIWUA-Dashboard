...
<head>
  ...
  <title>Crop Protection | Users </title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Extension Workers</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../Dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Extension Workers</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Extension Workers Records</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <?php
				require_once('../../Connection/connect.php');
				$sales6 ="SELECT FullNames,Email,Telephone,Address,created_at,ApprovalStatus,ProfilePic,IDDesc FROM `registration` where DOB is NOT NULL order by IDDesc Desc";
				...
				while($row5=mysqli_fetch_assoc($result5)){
				 ...
				 echo "<td>".$row5['created_at']."</td>";
				  ...
				  $id=$row5['IDDesc']; 
				  $approvals=$row5['ApprovalStatus'];
				  if($approvals=='Approved'){
					 echo "<td>".$row5['ApprovalStatus']."</td>";  
				  }else{
				  echo'<td><form method="get" ><a href="AppMembersTable.php"><button type="submit" name="Edit"  value="'.$id.'" class="btn btn-block btn-warning">Approve</button></a></form></td>'; 
				  }
				   echo "<td><img src=".$row5['ProfilePic']." height='100' width='100'></td>";
				
				  echo'<td><form method="get" ><a href="AppMembersTable.php"><button type="submit" name="delete"  value="'.$id.'" class="btn btn-block btn-danger">Delete</button></a></form></td>'; 
                echo"</tr>";
				}
				?>
				<?php
				if(isset($_GET['delete'])){
					$id=$_GET['delete'];	
                        if(isset($id)){
				$sales6 ="DELETE  FROM registration WHERE IDDesc='".$id."'";
				$result=mysqli_query($link,$sales6);
				if($result){
				echo '<script type="application/javascript">';
				echo'alert("App user successfully Deleted");';
				echo'window.location.href="AppMembersTable.php";';
				echo '</script>';
							}else{
				echo '<script type="application/javascript">';
				echo'alert("App User Delete Failed");';
				//echo'alert("'.$id.'");';
				echo'window.location.href="AppMembersTable.php";';
				echo '</script>';
								}
				...
				$id=$_GET['Edit'];
				if(isset($id)){
					$sales6 ="UPDATE  registration SET ApprovalStatus='Approved' WHERE IDDesc='".$id."'";
				$result=mysqli_query($link,$sales6);
				if($result){
					echo '<script type="application/javascript">';
				echo'alert("App User Approval Successful");';
				echo'window.location.href="AppMembersTable.php";';
				echo '</script>';
				}else{
				echo '<script type="application/javascript">';
				echo'alert("App User Approval Failed");';
				echo'window.location.href="AppMembersTable.php";';
				echo '</script>';
								}
				}
