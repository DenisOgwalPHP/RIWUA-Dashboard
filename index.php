<!--
Author: Denis Ogwal
Author URL: http://dithertechnologies
-->
<?php
//session_start();
?>
...
<html lang="en">
<head>
<title>Crop protection | Login</title>
<!-- Meta tag Keywords -->
...
<div data-vide-bg="video/keyboard">
	<div class="main-container">
		...
		<div class="main-content-agile">
			...
			<div class="sub-main-w3ls">	
				<form action="login.php" method="post">
					<input name="email" type="text" required placeholder="Enter your UserName/ Email" autocomplete="on">
					...
					<div class="checkbox-w3">
						...
						<a href="home.html">I have No Account!</a>
						<div class="clear"></div>
					</div>
		...
		<!--footer-->
		<div class="footer">
			<p>Copyright &copy; 2019 Crop Protection. All rights reserved <!--| Design by <a href="http://"></a>--></p>
		</div>
		<!--//footer-->
	</div>
</div>
